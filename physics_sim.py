...
# use copy instead of assignment as suggested on the forums
    def reset(self):
        self.time = 0.0
 ...
 #      return linear_drag
    ...
    def get_linear_forces(self, thrusts):
        ...
        #drag_body_force = self.get_linear_drag() # was suggested in the forums in combination with the function change above
        ...
        # if on the ground, avoid getting pushed down
